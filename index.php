    ...
    <div class="container rounded-5 text-center shadow p-5" style="background: #fff;">
      <div class="row">
        <div class="col-md-6" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
          ...
          <p class="pt-3">
            Ingin melakukan ujian dengan lebih mudah dan efisien? Kini, dengan Ruangujian, Anda dapat melakukan ujian
            secara online tanpa perlu khawatir tentang peralatan atau ruang ujian yang terbatas.
          </p>
        </div>
